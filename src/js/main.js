...
function result(imageNum = 7) {
  ...
  const res = (char, num) =>
  {
	...
	if((num-1) % 3 === 0)
	{
		otpt = `<div class="result col-4 px-0 pb-1 d-flex"><div class="flex-fill row mx-0 result-mcontainer p-1 border rounded-lg"><div class="d-flex right col-12 col-xl-10 pl-0 pr-0 justify-content-center"><div class="row mx-0"><div class="pl-1 pr-0 d-flex col-12 text-break text-center" title="${charTooltip}">${num}. ${charName}</div></div></div></div></div>`;
	}
	else
	{
